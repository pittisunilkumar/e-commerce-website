...
function getBrands(){
    ...
    while($row_brands=mysqli_fetch_array($run_brands)){
        ...
        $brand_tiitle=$row_brands['brand_title'];
        echo "<li><a href='index.php?cat=$brand_id'>$brand_tiitle</a></li>";
    }
...
function get_pro_by_cat_id(){
    ...
    if(isset($_GET['cat'])){
        ...
        if($count_cats==0){
            echo "<h2 style='padding:20px;'>No products where foundin thsi category</h2>";
        }
...
function cart(){
    ...
    if(isset($_GET['add_cart'])){
        ...
        if(mysqli_num_rows($run_check_pro)>0){
            ...
            if($run_insert_pro){
                echo "Record has inserted successful";
            }
...
function get_pro_by_brand_id(){
    ...
    if(isset($_GET['brand'])){
        ...
        $get_brand_pro="select * from products where product_cat='$brand_id'";
